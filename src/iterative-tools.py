...
search_tool = TavilySearch(max_results=5, api_key=os.getenv("TAVILY_API_KEY"))
...
# Writter LLM with tools bound

writer_llm = ChatGroq(model="openai/gpt-oss-120b", api_key=os.getenv("GROQ_API_KEY"), temperature=0.7)
writer_llm_with_tools = writer_llm.bind_tools(tools)

# Reviewer LLM with tools bound

reviewer_llm = ChatGroq(model="openai/gpt-oss-120b", api_key=os.getenv("GROQ_API_KEY"), temperature=0.1)
